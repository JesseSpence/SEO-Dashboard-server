 ...
 */
export function computeRollingSums(dailyRows: DailyRow[], metricName: string, windowDays: number = 28): Array<{ date: string; current: number; previous: number }> {
 ...
 */
export function computeUpdatePriority(gscData: PageData[], ga4Data: PageData[], currentPeriod: Array<{ date: string; current: number; previous: number }>, previousPeriod: Array<{ date: string; current: number; previous: number }>): UpdatePriorityScore[] {
 ...
 */
export function calculateEngagementScore(sessions: number, engagedSessions: number, averageSessionDuration: number): number {

class QueriesDashboard {
    ...
    async getQueriesForPage(pageUrl) {
        try {
            ...
            const queries = await this.fetchData('/api/gsc/queries', {
                page: pageUrl,
                start: startDateStr,
                end: endDateStr,
                limit: 100
            ...
            console.log(this.mockMode ? '🎭 Mock GSC queries received:' : '📊 GSC queries received:', queries);
